...
Ge.Consumer;
function Fe(e2) {
  var t2 = reactExports.useContext(Ge), n2 = reactExports.useMemo(function() {
...
function We(e2) {
  ...
  function l2(e3) {
    var t3 = fe(), n3 = me(), o2 = reactExports.useContext(Ge), l3 = reactExports.useRef(t3.allocateGSInstance(a)).current;
    return t3.server && h2(l3, e3, t3, o2, n3), reactExports.useLayoutEffect(function() {
      if (!t3.server)
...
*:not(canvas, iframe, img, svg, video, svg *, symbol *) {
	all: unset;
	display: revert;
}
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Fe, { theme, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlobalStyle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(H1, { children: "Styled Components base theme" }),
